  ...
  universal: [
    ...
    /* 1. Causation , weight × 6 in scoring */
    {
      ...
      options: [
        ...
        {value: "sexual_excess",                     label: "Sexual excess"},
        {value: "loss_of_fluids",                    label: "Loss of fluids"},
        {value: "overwork",                          label: "Overwork"},
        {value: "mental_strain",                     label: "Mental strain"},
        {value: "suppressed_perspiration",           label: "Suppressed perspiration"},
    ...
    /* 4. Worse from , weight × 4 */
    {
      ...
      options: [
        ...
        {value: "cold_wet_weather",      label: "Cold wet weather"},
        {value: "morning",               label: "Morning"},
        {value: "afternoon",             label: "Afternoon"},
        {value: "winter",                label: "Winter"},
        {value: "summer",                label: "Summer"},
        {value: "lying_on_painful_side", label: "Lying on painful side"},
        {value: "lying_on_back",         label: "Lying on back"},
        {value: "lying_on_right_side",   label: "Lying on right side"},
        {value: "sitting",               label: "Sitting"},
        {value: "after_midnight",        label: "After midnight"},
        {value: "before_menses",         label: "Before menses"},
        {value: "during_menses",         label: "During menses"},
        {value: "mental_exertion",       label: "Mental exertion"},
        {value: "excitement",            label: "Excitement"},
        {value: "music",                 label: "Music"},
        {value: "tobacco_smoke",         label: "Tobacco smoke"},
        {value: "alcohol",               label: "Alcohol"},
        {value: "coffee",                label: "Coffee"},
        {value: "change_of_weather",     label: "Change of weather"},
    ...
    /* 5. Better from , weight × 4 */
    {
      ...
      options: [
        ...
        {value: "cool_open_air",       label: "Cool open air"},
        {value: "cool_room",           label: "Cool room"},
        {value: "walking",             label: "Walking"},
        {value: "gentle_motion",       label: "Gentle motion"},
        {value: "warm_room",           label: "Warm room"},
        {value: "warm_wraps",          label: "Warm wraps"},
        {value: "warm_food",           label: "Warm food"},
        {value: "cold_bathing",        label: "Cold bathing"},
        {value: "perspiration",        label: "Perspiration"},
        {value: "expectoration",       label: "Expectoration"},
        {value: "urination",           label: "Urination"},
        {value: "tight_bandage",       label: "Tight bandage"},
        {value: "lying_still",         label: "Lying still"},
        {value: "kneeling",            label: "Kneeling"},
        {value: "bending_double",      label: "Bending double"},
        {value: "fresh_air",           label: "Fresh air"},
        {value: "closing_eyes",        label: "Closing eyes"}
      ]
    },
